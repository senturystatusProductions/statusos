const CACHE="statusos-v1.1.0";
const ASSETS=["./","./index.html","./style.css","./storage-service.js","./sync-service.js","./foundation.js","./habits-service.js","./music-service.js","./public-beta.js","./daily-briefing.js","./app.js","./auth.js","./config.js","./manifest.json","./icon-192.png","./icon-512.png"];
